...
const getPracticalFiles = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const practicalFiles = yield practicalfiles_schema_1.default.find({});
...
exports.default = getPracticalFiles;
